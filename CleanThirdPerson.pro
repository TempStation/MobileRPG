...
unrealRootPath=/home/unknown/Apps/UnrealEngine
CleanThirdPersonRootPath=/home/unknown/Documents/Projects/MobileRPG

gameProjectFile=/home/unknown/Documents/Projects/MobileRPG/CleanThirdPerson.uproject
...
include(CleanThirdPersonSource.pri)
include(CleanThirdPersonHeader.pri)
include(CleanThirdPersonConfig.pri)
include(CleanThirdPersonIncludes.pri)
include(CleanThirdPersonDefines.pri)
...
CleanThirdPerson-Linux-Debug.commands = $$build CleanThirdPerson Linux Debug  -project="\"$$gameProjectFile\"" $$args
CleanThirdPerson-Linux-DebugGame.commands = $$build CleanThirdPerson Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CleanThirdPerson-Linux-Shipping.commands = $$build CleanThirdPerson Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CleanThirdPerson-Linux-Test.commands = $$build CleanThirdPerson Linux Test  -project="\"$$gameProjectFile\"" $$args
CleanThirdPerson.commands = $$build CleanThirdPerson Linux Development  -project="\"$$gameProjectFile\"" $$args

CleanThirdPersonClient-Linux-Debug.commands = $$build CleanThirdPersonClient Linux Debug  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonClient-Linux-DebugGame.commands = $$build CleanThirdPersonClient Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonClient-Linux-Shipping.commands = $$build CleanThirdPersonClient Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonClient-Linux-Test.commands = $$build CleanThirdPersonClient Linux Test  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonClient.commands = $$build CleanThirdPersonClient Linux Development  -project="\"$$gameProjectFile\"" $$args

CleanThirdPersonEditor-Linux-Debug.commands = $$build CleanThirdPersonEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonEditor-Linux-DebugGame.commands = $$build CleanThirdPersonEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonEditor-Linux-Shipping.commands = $$build CleanThirdPersonEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonEditor-Linux-Test.commands = $$build CleanThirdPersonEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonEditor.commands = $$build CleanThirdPersonEditor Linux Development  -project="\"$$gameProjectFile\"" $$args

CleanThirdPersonServer-Linux-Debug.commands = $$build CleanThirdPersonServer Linux Debug  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonServer-Linux-DebugGame.commands = $$build CleanThirdPersonServer Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonServer-Linux-Shipping.commands = $$build CleanThirdPersonServer Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonServer-Linux-Test.commands = $$build CleanThirdPersonServer Linux Test  -project="\"$$gameProjectFile\"" $$args
CleanThirdPersonServer.commands = $$build CleanThirdPersonServer Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UE4Server \
	CleanThirdPerson-Linux-Debug \
	CleanThirdPerson-Linux-DebugGame \
	CleanThirdPerson-Linux-Shipping \
	CleanThirdPerson-Linux-Test \
	CleanThirdPerson \
	CleanThirdPersonClient-Linux-Debug \
	CleanThirdPersonClient-Linux-DebugGame \
	CleanThirdPersonClient-Linux-Shipping \
	CleanThirdPersonClient-Linux-Test \
	CleanThirdPersonClient \
	CleanThirdPersonEditor-Linux-Debug \
	CleanThirdPersonEditor-Linux-DebugGame \
	CleanThirdPersonEditor-Linux-Shipping \
	CleanThirdPersonEditor-Linux-Test \
	CleanThirdPersonEditor \
	CleanThirdPersonServer-Linux-Debug \
	CleanThirdPersonServer-Linux-DebugGame \
	CleanThirdPersonServer-Linux-Shipping \
	CleanThirdPersonServer-Linux-Test \
	CleanThirdPersonServer \
